export const testbnbTOKENS = {
  USDT: {
    address: "0x397E696881DA1b85834BD7b6289925f8B9a1ee8a",
    symbol: "USDT",
    decimals: 18,
  },
};
export const rpcs = {
  ...
  optimism:
    "https://opt-mainnet.nodereal.io/v1/aff09ffcae0a40ae80cd7fe3d1a9cf35",
  testBsc: "https://data-seed-prebsc-1-s1.binance.org:8545",
  astar:
